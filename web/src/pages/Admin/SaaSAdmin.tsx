...
// Interface define o formato dos dados que vêm da API
interface Tenant {
  id: string;
  name: string;
  slug: string;
...
export function SaaSAdmin() {
  ...
  // Função para criar nova barbearia
                  ...
                  {tenants.map((tenant) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-zinc-500">
                        {/* Proteção para não quebrar se a data vier vazia */}
                        {tenant.created_at
